...
function AdminDashboard({ onLogout }) {
                ...
                "AdminDashboard.useEffect.fetchBookings": async ()=>{
                    ...
                    try {
                        ...
                        const bookingsData = querySnapshot.docs.map({
                            "AdminDashboard.useEffect.fetchBookings.bookingsData": (doc)=>({
                                    id: doc.id,
                                    ...doc.data(),
                                    createdAt: doc.data().createdAt?.toDate().toISOString() // Convert timestamp
                                })
                        }["AdminDashboard.useEffect.fetchBookings.bookingsData"]);
    ...
    const handleStatusChange = async (bookingId, newStatus)=>{
        ...
        try {
            const bookingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "bookings", bookingId);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(bookingRef, {
                status: newStatus,
    ...
    const pendingOrders = bookings.filter((b)=>b.status !== 'delivered').length;
...
_s(AdminDashboard, "Yixl3lN7K42FNGUv62WuRakE7mc=", false, function() {
    return [
...
//# sourceMappingURL=src_1649ca76._.js.map